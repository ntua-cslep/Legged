...
set(gcf, 'Position', [100 50 750 800],'color','w');
...
gray_tone = 0.2;
plot(x_FRfoot(1:n), y_FRfoot(1:n),'Color',[gray_tone gray_tone gray_tone],'LineWidth',0.1)
...
plot([x_FRknee(i) x_FR1(i)],[y_FRknee(i) y_FR1(i)],'k','LineWidth',2)
plot([x_FR1(i) x_FR2(i)],[y_FR1(i) y_FR2(i)],'k','LineWidth',2)
plot([x_FR1(i) x_FR3(i)],[y_FR1(i) y_FR3(i)],'k','LineWidth',2)
plot([x_FR4(i) x_FRfoot(i)],[y_FR4(i) y_FRfoot(i)],'k','LineWidth',2)
plot([xForeRightHip(i) x_FR5(i)],[yForeRightHip(i) y_FR5(i)],'k','LineWidth',2)
plot([x_FR5(i) x_FR3(i)],[y_FR5(i) y_FR3(i)],'k','LineWidth',2)
% Plot joints
plot(x_FRknee(i),y_FRknee(i),'o','MarkerFaceColor','w','MarkerSize',4)
...
plot(x_FRfoot(i),y_FRfoot(i),'o','MarkerFaceColor','w','MarkerSize',4)   
...
% Plot actual foot trajectory
plot(x_HRfoot(1:n), y_HRfoot(1:n),'Color',[gray_tone gray_tone gray_tone],'LineWidth',0.1)
...
plot([x_HRknee(i) x_HR1(i)],[y_HRknee(i) y_HR1(i)],'k','LineWidth',2)
plot([x_HR1(i) x_HR2(i)],[y_HR1(i) y_HR2(i)],'k','LineWidth',2)
plot([x_HR1(i) x_HR3(i)],[y_HR1(i) y_HR3(i)],'k','LineWidth',2)
plot([x_HR4(i) x_HRfoot(i)],[y_HR4(i) y_HRfoot(i)],'k','LineWidth',2)
plot([xHindRightHip(i) x_HR5(i)],[yHindRightHip(i) y_HR5(i)],'k','LineWidth',2)
plot([x_HR5(i) x_HR3(i)],[y_HR5(i) y_HR3(i)],'k','LineWidth',2)
% Plot joints
plot(x_HRknee(i),y_HRknee(i),'o','MarkerFaceColor','w','MarkerSize',4)
...
plot(x_HRfoot(i),y_HRfoot(i),'o','MarkerFaceColor','w','MarkerSize',4)  
...
% Plot actual foot trajectory
plot(x_FLfoot(1:n), y_FLfoot(1:n),'Color',[gray_tone gray_tone gray_tone],'LineWidth',0.1)

% Plot Fore Left Leg
plot([xForeLeftHip(i) x_FLknee(i)],[yForeLeftHip(i) y_FLknee(i)],'k','LineWidth',4)
%plot([x_FLknee(i) x_FLfoot(i)],[y_FLknee(i) y_FLfoot(i)],':','LineWidth',1)
plot([x_FLknee(i) x_FL1(i)],[y_FLknee(i) y_FL1(i)],'k','LineWidth',2)
plot([x_FL1(i) x_FL2(i)],[y_FL1(i) y_FL2(i)],'k','LineWidth',2)
plot([x_FL1(i) x_FL3(i)],[y_FL1(i) y_FL3(i)],'k','LineWidth',2)
plot([x_FL4(i) x_FLfoot(i)],[y_FL4(i) y_FLfoot(i)],'k','LineWidth',2)
plot([xForeLeftHip(i) x_FL5(i)],[yForeLeftHip(i) y_FL5(i)],'k','LineWidth',2)
plot([x_FL5(i) x_FL3(i)],[y_FL5(i) y_FL3(i)],'k','LineWidth',2)
% Plot joints
plot(x_FLknee(i),y_FLknee(i),'o','MarkerFaceColor','w','MarkerSize',4)
...
plot(x_FLfoot(i),y_FLfoot(i),'o','MarkerFaceColor','w','MarkerSize',4)  

% Plot Axis
axis equal
axis([xForeLeftHip(i)-0.3 xForeLeftHip(i)+0.3 -0.65 0.10])
...
% Plot actual foot trajectory
plot(x_HLfoot(1:n), y_HLfoot(1:n),'Color',[gray_tone gray_tone gray_tone],'LineWidth',0.1)

% Plot Hind Left Leg
plot([xHindLeftHip(i) x_HLknee(i)],[yHindLeftHip(i) y_HLknee(i)],'k','LineWidth',4)
%plot([x_HLknee(i) x_HLfoot(i)],[y_HLknee(i) y_HLfoot(i)],':','LineWidth',1)
plot([x_HLknee(i) x_HL1(i)],[y_HLknee(i) y_HL1(i)],'k','LineWidth',2)
plot([x_HL1(i) x_HL2(i)],[y_HL1(i) y_HL2(i)],'k','LineWidth',2)
plot([x_HL1(i) x_HL3(i)],[y_HL1(i) y_HL3(i)],'k','LineWidth',2)
plot([x_HL4(i) x_HLfoot(i)],[y_HL4(i) y_HLfoot(i)],'k','LineWidth',2)
plot([xHindLeftHip(i) x_HL5(i)],[yHindLeftHip(i) y_HL5(i)],'k','LineWidth',2)
plot([x_HL5(i) x_HL3(i)],[y_HL5(i) y_HL3(i)],'k','LineWidth',2)
% Plot joints
plot(x_HLknee(i),y_HLknee(i),'o','MarkerFaceColor','w','MarkerSize',4)
...
plot(x_HLfoot(i),y_HLfoot(i),'o','MarkerFaceColor','w','MarkerSize',4)  
